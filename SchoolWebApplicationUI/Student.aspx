<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Student.aspx.cs" Inherits="SchoolWebApplicationUI.Student" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container mt-4">
        ...
        <asp:GridView ID="GridViewStudents" runat="server" CssClass="table table-striped table-bordered" AutoGenerateColumns="False" OnRowEditing="GridViewStudents_RowEditing" OnRowCancelingEdit="GridViewStudents_RowCancelingEdit" OnRowUpdating="GridViewStudents_RowUpdating" OnRowDeleting="GridViewStudents_RowDeleting" Height="211px" Width="1033px">
            <Columns>
